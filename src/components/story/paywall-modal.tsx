      ...
      >
        ...
        <div className="relative px-7 pb-6 pt-7">
          ...
          <button
            onClick={goPricing}
            disabled={!!checkingOut}
            className="group mt-6 flex w-full items-center justify-between rounded-full bg-foreground px-5 py-3.5 text-sm font-semibold text-background transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:bg-foreground/90 active:scale-[0.98] disabled:opacity-50 dark:bg-white dark:text-[oklch(0.15_0_0)]"
          >
