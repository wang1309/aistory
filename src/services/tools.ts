...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    nameKey: "ai_tools.tools.pictionary_word_generator.name",
    shortDescKey: "ai_tools.tools.pictionary_word_generator.desc",
    module: "ai-tools",
    category: "utility",
    href: "/ai-tools/pictionary-word-generator",
    icon: "RiPencilLine",
    accent: "rose",
    badges: ["new"],
    priority: 101,
  ...
  {
    slug: "ai-humanizer",
    nameKey: "ai_tools.tools.ai_humanizer.name",
    shortDescKey: "ai_tools.tools.ai_humanizer.desc",
    module: "ai-write",
    category: "rewriting",
    href: "/ai-tools/ai-humanizer",
