...
export const PRESET_WORKS: PresetWork[] = [
  ...
  },
  {
    ...
    nameKo: '나루토',
    category: 'anime',
    description: '忍者世界的热血成长故事,讲述鸣人追逐火影梦想的历程',
    worldview: '忍者村系统,五大国忍者,尾兽与人柱力,晓组织',
    characters: [
      {
        id: 'naruto',
        name: '漩涡鸣人',
        nameEn: 'Naruto Uzumaki',
        nameDe: 'Naruto Uzumaki',
        nameJa: 'うずまきナルト',
        nameKo: '우즈마키 나루토',
        role: 'main',
        description: '主角,九尾人柱力,热血开朗,永不放弃',
      },
      {
        id: 'sasuke',
        name: '宇智波佐助',
        nameEn: 'Sasuke Uchiha',
        nameDe: 'Sasuke Uchiha',
        nameJa: 'うちはサスケ',
        nameKo: '우치하 사스케',
        role: 'main',
        description: '宇智波一族幸存者,复仇者,冷酷天才',
      },
      {
        id: 'sakura',
        name: '春野樱',
        nameEn: 'Sakura Haruno',
        nameDe: 'Sakura Haruno',
        nameJa: '春野サクラ',
        nameKo: '하루노 사쿠라',
        role: 'main',
        description: '医疗忍者,纲手的弟子,聪明坚强',
      },
      {
        id: 'kakashi',
        name: '旗木卡卡西',
        nameEn: 'Kakashi Hatake',
        nameDe: 'Kakashi Hatake',
        nameJa: 'はたけカカシ',
        nameKo: '하타케 카카시',
        role: 'supporting',
        description: '第七班导师,拷贝忍者,写轮眼',
      },
      {
        id: 'itachi',
        name: '宇智波鼬',
        nameEn: 'Itachi Uchiha',
        nameDe: 'Itachi Uchiha',
        nameJa: 'うちはイタチ',
        nameKo: '우치하 이타치',
        role: 'supporting',
        description: '佐助的哥哥,天才忍者,悲剧英雄',
      },
    ],
    popularPairings: [
      ['naruto', 'sasuke'],
  ...
  },
  {
    ...
    nameDe: 'Jujutsu Kaisen',
    nameJa: '呪術廻戦',
    nameKo: '주술회전',
    category: 'anime',
    description: '现代咒术师对抗咒灵的黑暗奇幻故事',
    worldview: '咒术师与咒灵,咒术高专,咒力与领域展开',
    characters: [
      {
        id: 'yuji',
        name: '虎杖悠仁',
        ...
        nameKo: '이타도리 유지',
        role: 'main',
        description: '主角,宿傩容器,身体能力极强,善良正直',
      },
      {
        id: 'megumi',
        name: '伏黑惠',
        nameEn: 'Megumi Fushiguro',
        nameDe: 'Megumi Fushiguro',
        nameJa: '伏黒恵',
        nameKo: '후시구로 메구미',
        role: 'main',
        description: '十种影法术使用者,冷静理智,重视同伴',
      },
      {
        id: 'gojo',
        name: '五条悟',
        ...
        nameKo: '고조 사토루',
        role: 'supporting',
        description: '最强咒术师,六眼与无下限术式,自信狂傲',
      },
      {
        id: 'sukuna',
        name: '两面宿傩',
        nameEn: 'Ryomen Sukuna',
        nameDe: 'Ryomen Sukuna',
        nameJa: '両面宿儺',
        nameKo: '료멘 스쿠나',
        role: 'supporting',
        description: '咒灵之王,邪恶强大,寄宿于悠仁体内',
      },
      {
        id: 'nobara',
        name: '钉崎野蔷薇',
        nameEn: 'Nobara Kugisaki',
        nameDe: 'Nobara Kugisaki',
        nameJa: '釘崎野薔薇',
        nameKo: '쿠기사키 노바라',
        role: 'main',
        description: '稻草人术式,率真自信,时尚女孩',
      },
    ],
    popularPairings: [
      ['yuji', 'megumi'],
  ...
  },
  {
    id: 'my-hero-academia',
    name: '我的英雄学院',
    nameEn: 'My Hero Academia',
    nameDe: 'My Hero Academia',
    nameJa: '僕のヒーローアカデミア',
    nameKo: '나의 히어로 아카데미아',
    category: 'anime',
    description: '超能力时代的英雄养成故事',
    worldview: '个性社会,职业英雄与敌人联盟,雄英高中',
    characters: [
      {
        id: 'deku',
        name: '绿谷出久',
        nameEn: 'Izuku Midoriya',
        nameDe: 'Izuku Midoriya',
        nameJa: '緑谷出久',
        nameKo: '미도리야 이즈쿠',
        role: 'main',
        description: '主角,继承ONE FOR ALL,分析型英雄',
      },
      {
        id: 'bakugo',
        name: '爆豪胜己',
        nameEn: 'Katsuki Bakugo',
        nameDe: 'Katsuki Bakugo',
        nameJa: '爆豪勝己',
        nameKo: '바쿠고 카츠키',
        role: 'main',
        description: '出久的青梅竹马兼对手,爆破个性,傲娇好胜',
      },
      {
        id: 'todoroki',
        name: '轰焦冻',
        nameEn: 'Shoto Todoroki',
        nameDe: 'Shoto Todoroki',
        nameJa: '轟焦凍',
        nameKo: '토도로키 쇼토',
        role: 'main',
        description: '冰火双重个性,冷静强大,家庭问题',
      },
      {
        id: 'all-might',
        name: '欧尔麦特',
        ...
        nameKo: '올마이트',
        role: 'supporting',
        description: '和平象征,前NO.1英雄,出久的导师',
      },
      {
        id: 'shigaraki',
        name: '死柄木吊',
        nameEn: 'Tomura Shigaraki',
        nameDe: 'Tomura Shigaraki',
        nameJa: '死柄木弔',
        nameKo: '시가라키 토무라',
        role: 'supporting',
        description: '敌人联盟首领,崩坏个性,悲剧反派',
      },
    ],
    popularPairings: [
      ['deku', 'bakugo'],
  ...
  },
  {
    ...
    nameDe: 'Segen des Himmelsbeamten',
    nameJa: '天官賜福',
    nameKo: '천관사복',
    category: 'novel',
    description: '古风仙侠小说,讲述谢怜三度飞升的传奇故事',
    worldview: '仙界与鬼界,神官系统,三界往来,八百年恩怨',
    characters: [
      {
        id: 'xie-lian',
        name: '谢怜',
  ...
  },
  {
    ...
    nameKo: '두라대륙',
    category: 'novel',
    description: '玄幻小说,讲述唐三在斗罗大陆修炼成神的故事',
    worldview: '武魂系统,魂师等级,魂兽森林,两大帝国',
    characters: [
      {
        id: 'tang-san',
        name: '唐三',
      ...
      },
      {
        ...
        nameKo: '샤오우',
        role: 'main',
        description: '十万年魂兽化形,唐三的爱人,柔骨魅兔',
      },
      {
        id: 'dai-mubai',
        name: '戴沐白',
        ...
        nameKo: '다이무바이',
        role: 'main',
        description: '史莱克七怪之一,白虎武魂,星罗帝国三皇子',
      },
      {
        id: 'oscar',
        name: '奥斯卡',
  ...
  },
  {
    ...
    nameKo: '스타워즈',
    category: 'movie',
    description: '太空歌剧史诗,绝地武士与西斯的对抗',
    worldview: '银河帝国,原力,绝地与西斯,反抗军同盟',
    characters: [
      {
        id: 'luke',
        name: '卢克·天行者',
        nameEn: 'Luke Skywalker',
        nameDe: 'Luke Skywalker',
        nameJa: 'ルーク・スカイウォーカー',
        nameKo: '루크 스카이워커',
        role: 'main',
        description: '绝地武士,原力强大,正义善良',
      },
      {
        id: 'vader',
        name: '达斯·维达',
        ...
        nameKo: '다스 베이더',
        role: 'supporting',
        description: '西斯黑暗尊主,天行者阿纳金,悲剧英雄',
      },
      {
        id: 'leia',
        name: '莱娅·奥加纳',
      ...
      },
      {
        ...
        nameKo: '한 솔로',
        role: 'main',
        description: '走私者船长,千年隼号,玩世不恭但善良',
      },
      {
        id: 'obi-wan',
        name: '欧比旺·肯诺比',
        nameEn: 'Obi-Wan Kenobi',
        nameDe: 'Obi-Wan Kenobi',
        nameJa: 'オビ=ワン・ケノービ',
        nameKo: '오비완 케노비',
        role: 'supporting',
        description: '绝地大师,卢克的导师,智慧睿智',
      },
    ],
    popularPairings: [
      ['luke', 'han'],
  ...
  },
  {
    ...
    nameKo: '위처',
    category: 'movie',
    description: '奇幻世界的猎魔人冒险故事',
    worldview: '大陆世界,魔法与怪物,猎魔人组织,命运法则',
    characters: [
      {
        id: 'geralt',
        name: '杰洛特',
        nameEn: 'Geralt of Rivia',
        nameDe: 'Geralt von Riva',
        nameJa: 'リヴィアのゲラルト',
        nameKo: '리비아의 게롤트',
        role: 'main',
        description: '白狼,猎魔人,冷酷外表温柔内心',
      },
      {
        id: 'yennefer',
        name: '叶奈法',
        nameEn: 'Yennefer of Vengerberg',
        nameDe: 'Yennefer von Vengerberg',
        nameJa: 'ヴェンガーバーグのイェネファー',
        nameKo: '벵거버그의 예니퍼',
        role: 'main',
        description: '女术士,强大美丽,杰洛特的命运之人',
      },
      {
        id: 'ciri',
        name: '希里',
      ...
      },
      {
        ...
        nameKo: '단델리온',
        role: 'supporting',
        description: '吟游诗人,杰洛特的好友,话痨乐观',
      },
      {
        id: 'triss',
        name: '特莉丝',
        nameEn: 'Triss Merigold',
        nameDe: 'Triss Merigold',
        nameJa: 'トリス・メリゴールド',
        nameKo: '트리스 메리골드',
        role: 'supporting',
        description: '女术士,杰洛特的旧情人,善良温柔',
      },
    ],
    popularPairings: [
      ['geralt', 'yennefer'],
  ...
  },
  {
    ...
    nameDe: 'Game of Thrones',
    nameJa: 'ゲーム・オブ・スローンズ',
    nameKo: '왕좌의 게임',
    category: 'movie',
    description: '史诗级奇幻剧集,七国王座的争夺',
    worldview: '维斯特洛大陆,七大王国,铁王座,异鬼威胁',
    characters: [
      {
        id: 'jon',
        name: '琼恩·雪诺',
        ...
        nameKo: '존 스노우',
        role: 'main',
        description: '私生子,守夜人,冰与火之歌,高尚正直',
      },
      {
        id: 'daenerys',
        name: '丹妮莉丝·坦格利安',
        nameEn: 'Daenerys Targaryen',
        nameDe: 'Daenerys Targaryen',
        nameJa: 'デナーリス・ターガリエン',
        nameKo: '대너리스 타르가르옌',
        role: 'main',
        description: '龙母,风暴降生,不焚者,解放者',
      },
      {
        id: 'tyrion',
        name: '提利昂·兰尼斯特',
        nameEn: 'Tyrion Lannister',
        nameDe: 'Tyrion Lennister',
        nameJa: 'ティリオン・ラニスター',
        nameKo: '티리온 라니스터',
        role: 'main',
        description: '小恶魔,智慧过人,善良幽默',
      },
      {
        id: 'arya',
        name: '艾莉亚·史塔克',
        ...
        nameKo: '아리아 스타크',
        role: 'main',
        description: '无面者,刺客,独立坚强',
      },
      {
        id: 'jaime',
        name: '詹姆·兰尼斯特',
        nameEn: 'Jaime Lannister',
        nameDe: 'Jaime Lennister',
        nameJa: 'ジェイミー・ラニスター',
        nameKo: '제이미 라니스터',
        role: 'supporting',
        description: '弑君者,御林铁卫,复杂的骑士',
      },
    ],
    popularPairings: [
      ['jon', 'daenerys'],
  ...
  },
  {
    ...
    nameDe: 'League of Legends',
    nameJa: 'リーグ・オブ・レジェンド',
    nameKo: '리그 오브 레전드',
    category: 'game',
    description: '全球热门MOBA游戏,符文之地的英雄传说',
    worldview: '符文之地,德玛西亚与诺克萨斯,艾欧尼亚,皮尔特沃夫与祖安',
    characters: [
      {
        id: 'ezreal',
        name: '伊泽瑞尔',
  ...
  },
  {
    ...
    nameKo: '오버워치',
    category: 'game',
    description: '暴雪FPS游戏,未来世界的英雄组织',
    worldview: '未来地球,智械危机,守望先锋组织,黑爪',
    characters: [
      {
        id: 'soldier76',
        name: '士兵76',
        ...
        nameKo: '솔저: 76',
        role: 'main',
        description: '前守望先锋指挥官,杰克·莫里森,正义使者',
      },
      {
        id: 'reaper',
        name: '死神',
